...
class AddTaskFragment : BottomSheetDialogFragment() {
    ...
    override fun onCreateView(
        ...
        val binding :AddTaskFragmentBinding = DataBindingUtil.inflate(inflater,
            pl.heng.R.layout.add_task_fragment,null,true)
    ...
    private fun notifyHourChange(){
        val picker = TimePickerDialog(this.context, R.style.DialogTheme,
            TimePickerDialog.OnTimeSetListener { view, hourOfDay, minute ->
                viewModel.notifyTime.set(LocalTime.of(hourOfDay,minute))
    ...
    private fun endDateChange()
    {
        ...
        val picker = DatePickerDialog(this.context,
            DatePickerDialog.OnDateSetListener { view, year, monthOfYear, dayOfMonth ->
                viewModel.endDate.set(LocalDate.of(year,month,dayOfMonth))
            }, year, month, day
        )
        picker.show()
    }
